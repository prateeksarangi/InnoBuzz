...
facerec = dlib.face_recognition_model_v1('C:/Users/dell/Pictures/Camera Roll/Prateek.jpg')

win = dlib.image_window()

# Now process all the images
for f in glob.glob(os.path.join('C:/Users/dell/Pictures/Camera Roll','Prateek.jpg')):
